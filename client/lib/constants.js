...
// --- Contract ---
// export const REPUFI_SBT_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_UPGRAD_REPUFI_SBT_CONTRACT_ADDRESS;   //original
...
if (!REPUFI_SBT_CONTRACT_ADDRESS) {
    console.error("FATAL: NEXT_PUBLIC_UPGRAD_REPUFI_SBT_CONTRACT_ADDRESS is not defined.");
}
